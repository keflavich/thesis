...
\Figure{figures_chH2CO/W49_RGB_aplpy.png}
...
lines, we have $N_(\ortho) = 2.03\ee{12} $ and $1.56\ee{12}$ \persc for G43.16
...
$X_{13} = 1.77\ee{-6}$, the resulting \hh column densities are 3.5\ee{21} and
9.0 \ee{20} \percc respectively. 
The abundances of \ortho relative to \thirteenco are 3.2\ee{-4} and 9.8\ee{-4}
respectively, or relative to \hh, 5.8\ee{-10} and 1.7\ee{-9}, which are entirely consistent
with other measurements of $X_{\formaldehyde}$.
These are relatively modest column densities,
with $A_V=17$ and 4.5.
