...
\readerFive{Prof.~Michael Shull}	%  4rd person to sign thesis
...
\acknowledgements{	\OnePageChapter	% *MUST* BE ONLY ONE PAGE!
    ...
    Glenn, Neal Evans, Guy Stringfellow, Jonathan Williams, Wayne Schlingman,
    Yancy Shirley, Paul Harvey
	}
...
\input{ch_boundhii}
\input{ch_h2co}
\input{ch_h2colarge} % need to comment out everything in header of h2co_lowdens.tex for this piece of shit to work
\input{ch_software}
\input{ch_conclusion}
